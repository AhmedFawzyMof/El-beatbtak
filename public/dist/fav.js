...
function Furniture() {
  return _Furniture.apply(this, arguments);
}
function _Furniture() {
  _Furniture = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
      var favIds, body, getFurniture, data, html, container;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1)
          switch ((_context.prev = _context.next)) {
            case 0:
              favIds = JSON.parse(localStorage.getItem("favlist"));
              body = JSON.stringify({
                ids: favIds,
              });
              _context.next = 4;
              return fetch("/getFurnture", {
                method: "post",
                headers: {
            ...
            case 4:
              getFurniture = _context.sent;
              _context.next = 7;
              return getFurniture.json();
            case 7:
              data = _context.sent;
              html = "";
              ...
              if (data.Furniture.length > 0) {
                data.Furniture.forEach(function (f) {
                  html +=
                    '<div class="furniture">\n    <button id="addtofav" onclick="Remove(\''
                      .concat(
                        f.id,
                      ...
                      .concat(
                        f.id,
                        '">\n          <img class="image" src="data:image/png;base64,'
                      )
                      .concat(
                        f.image,
                        '" />\n          <div class="body">\n            <p>'
